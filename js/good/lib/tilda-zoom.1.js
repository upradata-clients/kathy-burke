...
function t_zoomHandler(t) {
    var card = t.closest(".mt-gallery_slider_card");
...
function t_zoom_lockScroll() {
    ...
    const a = (window.t_zoom__isiOS && 11 === window.t_zoom__iOSMajorVersion && !window.MSStream || t);
...
function t_zoom_unlockScroll() {
    ...
    if (a && b) {
        ...
        gsap.set(window, { scrollTo: Number(t) });
        window.createScrollSmoother();*/
    }
}
