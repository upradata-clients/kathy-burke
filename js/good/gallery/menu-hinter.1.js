...
const addMenuHinter = () => {
    ...
    const container = _.queryThrow('#rec747864295 .t959__container');
    const items = _.queryAllThrow('.t959__card', container);


    _.queryThrow('.t959__card-overlay', container).setAttribute('style', '');
    ...
    [ ..._.queryAllThrow('.t959__row', container) ].forEach(el => el.remove());
