    ...
    !function (e, t) {
        "object" == typeof exports && "undefined" != typeof module ?
            ...
            "function" == typeof define && define.amd ?
                define([ "exports" ], t) :
                t(window/* (e = e || self).window = e.window || {} */);
    }(this, function (e) {
        "use strict";
        function l() {
...
const addSplitText = () => {
    ...
    ! function (D, u) {
        "object" == typeof exports && "undefined" != typeof module ? u(exports) : "function" == typeof define && define.amd ? define([ "exports" ], u) :
            u(window /* (D = D || self).window = D.window || {} */);
    }(this, function (u) {
        "use strict";
...
const svgImageToInline = async (...queries) => {
    const images = queries.flatMap(query => typeof query === 'string' ? [ ...document.querySelectorAll(query) ] : query);
...
window.svgImageToInline = svgImageToInline;
